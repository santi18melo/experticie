...
Uso alternativo: python manage.py shell
Dentro del shell ejecuta: exec(open('test_productos_v2.py').read())
"""
...
Usuario.objects.filter(email__contains='prexcol').delete()
...
print("  3. Prueba los endpoints: http://localhost:8000/api/")
print("="*60)
