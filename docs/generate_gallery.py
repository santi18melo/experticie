...
def parse_markdown_files():
    ...
    rst_content.append("                :class: action-button-large")
    rst_content.append("")
    rst_content.append("                🚀 **Ir a la Aplicación**")
    rst_content.append("                ")
    rst_content.append("                *Acceso Frontend (Cliente/Ventas)*")
    rst_content.append("")
    rst_content.append("        .. grid-item::")
    ...
    rst_content.append("                :class: action-button-large")
    rst_content.append("")
    rst_content.append("                🎛️ **Ir al Backend**")
    rst_content.append("                ")
    rst_content.append("                *Panel Administrativo (Django)*")
    rst_content.append("")
    rst_content.append("")
    rst_content.append("---")
    rst_content.append("")
