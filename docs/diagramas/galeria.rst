...
A continuación se presentan todos los diagramas del sistema organizados visualmente.
Use las pestañas para alternar entre la visualización y el código fuente.

.. dropdown:: Diagrama Actividad
    :open:
    :icon: graph
...
.. dropdown:: Diagrama Colaboracion
    :open:
    :icon: graph
...
.. dropdown:: Diagrama Componentes Paquetes
    :open:
    :icon: graph
